...
export type AppMessage = {
  text: string;
  type?: MessageKind; // defaults to "info"
};
...
/** Color map for message kinds */
const typeToColor: Record<MessageKind, "blue" | "teal" | "yellow" | "red"> = {
  info: "blue",
  success: "teal",
  warning: "yellow",
  error: "red",
...
export default function ComponentMessage({
  ...
  // Tabs in Mantine expect value: string | null and onChange: (value: string | null) => void
  ...
  const filtered = useMemo(() => {
    ...
    const t = activeTab.toLowerCase() as MessageKind | "all";
      ...
      >
        ...
        <div style={{ flex: 1, minHeight: 0, overflow: "auto", padding: 8 }}>
          <div style={{ display: "flex", flexDirection: "column" }}>
            {filtered.map((msg, i) => {
              const color = typeToColor[(msg.type ?? "info") as MessageKind];
              return (
                  <Card
                      key={i}
                      radius="none"
