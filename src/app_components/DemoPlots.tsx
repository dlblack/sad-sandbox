...
export default function DemoPlots(): JSX.Element {
  ...
  async function exportGalleryPNG() {
    ...
    for (const item of plotList) {
      ...
      if (!div) continue;
      try {
        // @ts-expect-error plotly types aren’t included
  ...
  useEffect(() => {
    ...
    plot(refs.lineErr.current, {
      ...
      layout: {
        ...
        title: { text: "Hydrograph with Error Bars" },
        height: 320,
      },
    });
    ...
    plot(refs.ribbon.current, {
      ...
      layout: {
        ...AX("Hour", "Discharge (cfs)"),
        title: { text: "Flow with Three Confidence Ribbons" },
        height: 320,
      },
    });
    ...
    plot(refs.hist.current, {
      ...
      layout: {
        ...
        title: { text: "Histogram of Annual Peak Flows" },
        height: 320,
      },
    });
    ...
    plot(refs.boxOnly.current, {
      ...
      layout: {
        ...
        title: { text: "Seasonal Flow Distributions (Box)" },
        boxmode: "group",
        height: 320,
      },
    });
    ...
    plot(refs.boxViolin.current, {
      ...
      layout: {
        ...AX("Season", "Discharge (cfs)"),
        title: { text: "Seasonal Flow Distributions (Violin)" },
        height: 320,
      },
    });
    ...
    plot(refs.candlestick.current, {
      ...
      layout: {
        ...AX("Day", "Stage (ft)"),
        title: { text: "Daily Stage Range (ft)" },
        height: 320,
      },
    });
    ...
    plot(refs.heatmapTiles.current, {
      ...
      layout: {
        ...AX("Hour", "Day of Week"),
        title: { text: "Rainfall Intensity (in/hr) – Tile Heatmap" },
        height: 320,
      },
    });
