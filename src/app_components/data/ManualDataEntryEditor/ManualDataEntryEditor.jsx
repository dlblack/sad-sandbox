...
import PairedCurveTypeComboBox, { CURVE_TYPE_DEFAULTS } from "@/app_components/editor_components/combo_boxes/PairedCurveTypeComboBox.jsx";
        ...
        if (step === 1) {
            return (
                <div className="manual-entry-content" style={{ maxWidth: 480 }}>
                    <h4 className="mb-3">Create New Data Set</h4>
                    <hr />
...
// Step 2: PairedData (DSS or JSON)
                ...
                return (
                    <div>
                        ...
                        <div className="mb-3" style={{ maxWidth: 340 }}>
                            <label className="form-label font-xs mb-1">Curve Type</label>
                        ...
                        <div className="mb-3" style={{ maxWidth: 340 }}>
                            <label className="form-label font-xs mb-1">Y Label</label>
                        ...
                        <div className="mb-3" style={{ maxWidth: 340 }}>
                            <label className="form-label font-xs mb-1">Y Units</label>
                            <input className="form-control form-control-sm"
                                   value={pairedYUnits}
                        ...
                        <div className="mb-3" style={{ maxWidth: 340 }}>
                            <label className="form-label font-xs mb-1">X Label</label>
                            <input className="form-control form-control-sm"
                                   value={pairedXLabel}
                        ...
                        <div className="mb-3" style={{ maxWidth: 340 }}>
                            <label className="form-label font-xs mb-1">X Units</label>
                            <input className="form-control form-control-sm"
                                   value={pairedXUnits}
    ...
    return (
        <div className="wizard-fixed-size card p-3" style={{ height: "100%" }}>
