...
export interface PeaksOverThresholdAnalysisWizardProps {
  [key: string]: unknown;
}

export default function PeaksOverThresholdAnalysisWizard(
    props: PeaksOverThresholdAnalysisWizardProps
) {
