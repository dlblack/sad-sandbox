...
export interface DockableItemProps {
    expandToContents?: boolean;
    id: string | number;
    type: string;
    title?: string;
...
export default function DockableItem({
    ...
    const innerCard = (
        ...
        >
            ...
            <div
                className="card-body"
                style={{ flex: 1, minHeight: 0, minWidth: 0, overflow: "auto", padding: 0 }}
            >
                {children}
            </div>
        </Card>
    ...
    return (
        <Resizable
            ...
            axis="both"
            handle={(h: any, ref: React.Ref<HTMLSpanElement>) => (
