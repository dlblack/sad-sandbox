...
export interface TimeFieldProps extends Omit<React.InputHTMLAttributes<HTMLInputElement>, "value" | "defaultValue"> {
    value?: TimeValue;
...
export default function TimeField({
    ...
    function ClockIcon({ size = 14, stroke = 1.5 }: { size?: number; stroke?: number }) {
        return (
            <svg
                width={size}
                height={size}
    ...
    return (
        ...
        >
            <input
                ...
                value={raw}
                onChange={(e) => {
                    if (!isControlled) setRaw(e.target.value);
                    onChange?.(e);
                }}
