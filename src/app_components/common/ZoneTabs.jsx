...
export default function ZoneTabs({ tabs, activeId, setActiveId, closeTab, registry }) {
  return (
    <>
      <Tabs value={activeId} onChange={(v) => v && setActiveId(v)} keepMounted={false} variant="outline" radius="sm">
        <Tabs.List>
          {tabs.map((t) => {
